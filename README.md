...
Progam developed on Linux which encodes and decodes vowels using a TCP and UDP connection. The following is a YouTube link for demonstration: https://youtu.be/vJvpEUOz3xA. The following is the assignment description: https://pages.cpsc.ucalgary.ca/~carey/CPSC441/assignment2.html
## User manual
